...
$querry = "SELECT MAX(idversion) version_rep ,representante.idrepresentante AS Rep,nombre.descripcion AS Nombre1, apellido.descripcion AS Apellido1 FROM public.representante inner join nombre on representante.idnombre=nombre.idnombre
